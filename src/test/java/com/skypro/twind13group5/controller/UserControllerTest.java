...
class UserControllerTest {
    ...
    private static final UserType CORRECT_USER_TYPE_TWO = UserType.ADOPTER;
    ...
    private static final String CORRECT_MAIL = "Ivan@gmail.com";
    private static final String CORRECT_ADDRESS = "Moscow, Nevskaya 14";
